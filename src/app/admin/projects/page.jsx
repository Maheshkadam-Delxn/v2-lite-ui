...
//   } else if (isNaN(parseFloat(newProject.budget)) || parseFloat(newProject.budget) <= 0) {
...
//   if (!newProject.client_phone_number.trim()) {
//     newErrors.client_phone_number = "Client phone is required";
//   }
...
//                                     {newProject.project_description.length}/60 characters
//                                   </p>
//                                 </div>
...
//                                       value={newProject.client_phone_number}
//                                       onChange={handleInputChange}
//                                       onBlur={handleBlur}
...
//                       whileHover={{ scale: 1.1 }}
//                       whileTap={{ scale: 0.9 }}
//                       onClick={() => handleDeleteProject(project._id, project.project_name)}
...
const updateProject = async (projectId, projectData, token) => {
  ...
  const handleEditProject = (project) => {
    ...
    setNewProject({
      ...
      client_phone_number: project.clientPhone || "",
      address: project.address || "",
    });
    setIsProjectDropdownOpen(true);
  };
  ...
  const validateForm = () => {
    ...
    if (!newProject.project_code.trim()) {
      newErrors.project_code = "Project code is required";
    }else if(newProject.project_code.trim().length < 2) {
 ...
 const handleSubmit = async (e) => {
  ...
  try {
    ...
    // Create the complete data object manually
    const formData = {
      ...
      zoneOffset: newProject.zoneOffset,
      ...
      client_phone_number: newProject.client_phone_number,
