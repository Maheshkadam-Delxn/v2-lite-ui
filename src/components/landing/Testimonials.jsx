  ...
  return (
    <div className="bg-slate-50 py-20">
      <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="flex justify-center space-x-2 mt-6">
                {testimonials.map((_, index) => (
                  <button
                    key={index}
                    className={`w-3 h-3 rounded-full transition-all duration-300 ${
                      activeTestimonial === index ? 'bg-blue-400 w-8' : 'bg-gray-300 hover:bg-gray-400'
                    }`}
                    onClick={() => setActiveTestimonial(index)}
                  />
                ))}
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            <div className="grid lg:grid-cols-2">
              ...
              <div className="p-8">
                ...
                {/* Quote */}
                <blockquote className="border-l-4 border-blue-400 pl-4 italic text-slate-700 mb-4">
                  "{caseStudies[activeCase].quote}"
                </blockquote>
                <p className="text-sm text-slate-500">— {caseStudies[activeCase].author}</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-8 text-white">
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <button className="flex items-center space-x-2 text-blue-300 hover:text-blue-200 transition-colors duration-200">
                    <span className="font-medium">Read Full Case Study</span>
                    <ArrowRight className="w-4 h-4" />
                  </button>
                </div>
        ...
        {/* Call to Action */}
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-blue-400 to-blue-500 rounded-2xl p-12 text-white">
            <h3 className="text-3xl font-bold mb-4">Ready to Transform Your Construction Projects?</h3>
            <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
              Join thousands of construction professionals who are building faster, safer, and more efficiently with SkyStruct v2lite.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-white text-blue-500 px-8 py-4 rounded-lg font-semibold hover:bg-blue-50 transition-colors duration-200 shadow-lg">
                Start Free Trial
              </button>
              <button className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-blue-500 transition-colors duration-200">
                Schedule Demo
              </button>
            </div>
          </div>
