            ...
            <div className="space-y-4">
              <div onSubmit={handleNewsletterSubmit} className="flex space-x-3">
                <input
                  ...
                  onChange={(e) => setEmail(e.target.value)}
                  placeholder="Enter your work email"
                  className="flex-1 px-4 py-3 rounded-lg bg-white text-slate-800 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-300"
                  required
                />
                <button
                  type="submit"
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <div className="text-xl font-bold">SkyStruct</div>
                  <div className="text-blue-400 text-sm">v2lite</div>
                </div>
              </div>
              <p className="text-slate-300 leading-relaxed mb-6">
                Empowering construction teams worldwide with intelligent project management solutions. 
            ...
            <div className="flex space-x-4">
              {[
                ...
                <a
                  key={index}
                  href={social.href}
                  className="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-blue-400 transition-colors duration-200"
                  aria-label={social.label}
                >
                  <social.icon className="w-5 h-5" />
                </a>
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            ...
            <div className="flex flex-wrap items-center space-x-6 text-sm">
              ...
              <a href="#accessibility" className="text-slate-400 hover:text-blue-400 transition-colors duration-200">
                Accessibility
              </a>
              <a href="#sitemap" className="text-slate-400 hover:text-blue-400 transition-colors duration-200">
                Sitemap
              </a>
            </div>
