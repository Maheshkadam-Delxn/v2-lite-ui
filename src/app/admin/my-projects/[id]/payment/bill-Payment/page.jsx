...
const billData = [
  ...
  { poNo: "GH101-PO-00021", poDate: "2025-20-09", supplier: "XYZ Suppliers", items: 2, amount: "62.00 K" },
  { poNo: "GH101-PO-00020", poDate: "2025-20-09", supplier: "Reliable Steel Traders", items: 1, amount: "503.50 K" },
  { poNo: "GH101-PO-00019", poDate: "2025-20-08", supplier: "XYZ Suppliers", items: 2, amount: "400.00 K" },
  { poNo: "GH101-PO-00014", poDate: "2025-23-07", supplier: "ABC Constructions", items: 2, amount: "324.00 K" },
  ...
  { poNo: "GH101-PO-00009", poDate: "2025-28-05", supplier: "XYZ Suppliers", items: 1, amount: "71.00 K" },
];
...
export default function BillPaymentPage() {
  ...
  const filteredBills = billData.filter((bill) =>
    ...
    bill.poDate.toLowerCase().includes(search.toLowerCase()) ||
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex-1 grid grid-cols-5 gap-2 text-sm">
                    ...
                    <div className="flex flex-col">
                      ...
                      <p className="font-semibold text-gray-900">{bill.poDate}</p>
                    </div>
                    <div className="flex flex-col">
                      <p className="text-gray-500 text-xs font-medium">Supplier</p>
                      <p className="font-semibold text-gray-900 truncate">{bill.supplier}</p>
                    </div>
                    <div className="flex flex-col">
                      <p className="text-gray-500 text-xs font-medium">Items</p>
                      <p className="font-semibold text-gray-900">{bill.items}</p>
                    </div>
                    <div className="flex flex-col">
