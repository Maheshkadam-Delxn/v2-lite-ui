  ...
  const createProject = async (e) => {
    ...
    try {
      ...
      Object.keys(newProject).forEach((key) => {
        ...
        } else if (key !== "projectPhoto") {
          formData.append(key, newProject[key]);
        }
      });

      formData.append("name", newProject.name);
      formData.append("code", newProject.code);
      formData.append("type", newProject.type);
      formData.append("budget", newProject.budget);
      formData.append("currency", newProject.currency);
      formData.append("zoneOffset", newProject.zoneOffset);
      ...
      // Handle file upload
      if (newProject.projectPhoto) {
        formData.append("projectPhoto", newProject.projectPhoto);
      }
